    ...
    <div className="w-full h-fit flex flex-col gap-4 p-4">
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>
          ...
          Company", "We", "Us" or "Our" in this Agreement) refers to Notes App.
        </li>
        <li>
        ...
        <li>
          <span className="font-bold">Country</span> refers to: Maharashtra,
          India
        </li>
        <li>
      ...
      <h3 className="text-lg font-bold">Necessary / Essential Cookies</h3>
      <p>
      ...
      <h3 className="text-lg font-bold">Functionality Cookies</h3>
      <p>
        Type: Persistent Cookies
        <br />
        Administered by: Us
      ...
      <h2 className="text-xl font-bold">Disclosure for Law Enforcement</h2>
      <p>
      ...
      <p>
        ...
        at{/* emailto code.tejas@gmail.com */}
        <span className="text-blue-400"> code.tejas@gmail.com</span>
      </p>
    </div>
  );
};
